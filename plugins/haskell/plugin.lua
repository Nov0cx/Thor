-- Haskell syntax highlighting. Uses the compiled-in tree-sitter "haskell"
-- grammar and maps its highlight-query capture names to theme color roles.
-- Capture names are matched by their head too, so "keyword.import" -> "keyword".
