...
// How many columns a rune covers. Zero for a combining mark or another
// zero-width code point, two for East Asian wide and fullwidth forms and for
// the emoji blocks, one for everything else. The tables cover the ranges a
// terminal meets; they are not the whole Unicode database.
...
// True when the rune only decorates the cell before it.
rune_is_combining :: proc(r: rune) -> bool {
    return r >= 0xa0 && in_ranges(r, ZERO_WIDTH[:])
}
...
@(private = "file")
in_ranges :: proc(r: rune, ranges: []Range) -> bool {
...
// Combining marks, format controls and the variation selectors.
@(private = "file")
ZERO_WIDTH := [?]Range {
    ...
    {0x0c3e, 0x0c40}, {0x0c46, 0x0c48}, {0x0c4a, 0x0c4d}, {0x0c81, 0x0c81},
    {0x0cbc, 0x0cbc}, {0x0cbf, 0x0cbf}, {0x0cc6, 0x0cc6}, {0x0ccc, 0x0ccd},
    {0x0d01, 0x0d01}, {0x0d41, 0x0d44}, {0x0d4d, 0x0d4d}, {0x0dca, 0x0dca},
    ...
    {0x1032, 0x1037}, {0x1039, 0x103a}, {0x1058, 0x1059}, {0x105e, 0x1060},
    ...
    {0x17c9, 0x17d3}, {0x17dd, 0x17dd}, {0x180b, 0x180e}, {0x18a9, 0x18a9},
    ...
    {0x1a7f, 0x1a7f}, {0x1ab0, 0x1aff}, {0x1b00, 0x1b03}, {0x1b34, 0x1b34},
    {0x1b36, 0x1b3a}, {0x1b3c, 0x1b3c}, {0x1b42, 0x1b42}, {0x1b6b, 0x1b73},
    {0x1b80, 0x1b81}, {0x1ba2, 0x1ba5}, {0x1ba8, 0x1ba9}, {0x1be6, 0x1be6},
    {0x1be8, 0x1be9}, {0x1bed, 0x1bed}, {0x1bef, 0x1bf1}, {0x1c2c, 0x1c33},
    {0x1c36, 0x1c37}, {0x1cd0, 0x1cd2}, {0x1cd4, 0x1ce0}, {0x1ce2, 0x1ce8},
    {0x1ced, 0x1ced}, {0x1cf4, 0x1cf4}, {0x1dc0, 0x1dff}, {0x200b, 0x200f},
    ...
    {0x10a01, 0x10a0f}, {0x10a38, 0x10a3f}, {0x11001, 0x11001},
    {0x11038, 0x11046}, {0x11080, 0x11081}, {0x110b3, 0x110b6},
    {0x11100, 0x11102}, {0x11127, 0x1112b}, {0x1112d, 0x11134},
    {0x11180, 0x11181}, {0x111b6, 0x111be}, {0x116ab, 0x116ad},
    {0x116b0, 0x116b7}, {0x16af0, 0x16af4}, {0x16b30, 0x16b36},
...
// East Asian wide and fullwidth, plus the emoji blocks that draw two columns.
@(private = "file")
WIDE := [?]Range {
